...
export const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <div className="fixed right-4 top-4 bottom-4 z-40">
      <div className="bg-background/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-lg w-80 h-full flex flex-col overflow-hidden">
